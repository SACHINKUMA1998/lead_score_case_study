...
- lead_score.ipynb : The python file showing coding and data analysis
- answers.pdf : Some subjective questions answered
- lead_score_analysis.pdf : Final Presentation
